...
import { BookOpen, Clock, Target, Zap, TrendingUp, Calendar, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">You&apos;re on track with your UPSC preparation. Keep up the momentum!</p>
      </div>
